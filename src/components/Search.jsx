...
const Search = () => {
  ...
  return (
    <div className="relative w-full px-2 md:px-4 lg:px-8 py-3 md:py-6">
      <form 
        ref={formRef}
        onSubmit={(e) => {
          e.preventDefault();
        ...
        className="flex items-center bg-white shadow-sm border-none rounded-lg w-full transition-all duration-200 hover:shadow-md"
      >
        <div className="flex items-center w-full md:w-[586px] border rounded-lg overflow-hidden bg-white p-1 md:p-0">
          <input
            type="text"
